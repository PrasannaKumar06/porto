        ...
        <div class="art-info-bar">
          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <!-- avatar end -->
              <!-- name -->
              <h5 class="art-name mb-10"><a href="/home.php">Artur Carter</a></h5>
              <!-- post -->
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-a art-pagination">
                      <!-- button -->
                      <a href="/blog-2-col.php" class="art-link art-color-link art-w-chevron art-left-link"><span>Previous page</span></a>
                      <div class="art-pagination-center art-m-hidden">
                        <a href="/blog-2-col.php"></a>
                        <a href="/blog-2-col.php">1</a>
                        <a class="art-active-pag" href="/blog-2-col.php">2</a>
                        <a href="/blog-2-col.php">3</a>
                        <a href="/blog-2-col.php">...</a>
                      </div>
                      <!-- button -->
                      <a href="/blog-2-col.php" class="art-link art-color-link art-w-chevron"><span>Next page</span></a>
                    </div>
                    <!-- pagination end -->
            ...
            <div class="art-scroll-frame">
              ...
              <nav id="swupMenu">
                ...
                <ul class="main-menu">
                  ...
                  <!-- menu item -->
                  <li class="menu-item"><a href="onepage.php" target="_blank">Onepage</a></li>
                </ul>
                <!-- menu list end -->
              </nav>
              <!-- menu end -->
